   ...
   class Editprofile extends Component {
    ...
    render() {
        ...
        return (
            ...
            <a  class="btn" id="btn" onClick={this.handleImageUpdate}>Update Image</a>
            <a class="btn red" onClick={this.handleImageRemove}>Remove</a>
            </div>
                ...
                <div class="form-content" >
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <Popup contentStyle={{width:'418px',left: '35.125px'}} trigger={<div class="form-group" id="printjobname" 
                                onChange={this.handleCheckLength} ><h6 id="valse" >Applied For</h6>
                                <i class="fa fa-sort-down" style={{fontSize:'30px',color:'#3fb2aa',float:'right',marginTop:'-34px'}}></i>
                                </div>} 
                                 >
                    ...
                    <p>
                    <label>
                    <input name="working"  value="true" onClick={this.handleRadio1}  type="radio" />
                        <span id="label">Yes</span>
                        </label>
                    </p>
                    <p>
                    <label>
                        <input name="working" value="false" onClick={this.handleRadio1} type="radio"/>
                        <span id="label">No</span>
                    </label>
                    </p>
                    </div>
                    ...
                    <div class="col-md-6">
                    <button type="button"  onSubmit={this.handleCancel} id="cancel">Cancel</button>
                    </div>
                    <div class="col-md-6">
                    <button type="button"  onClick={this.handleSubmit} id="save">Save</button>
                    </div>
                    </div>
                     {/* End section-6 */}
                    {/* <div class="profile-header-container" id="submission"> 
