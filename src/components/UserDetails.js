...
class UserDetails extends Component {
  ...
  render() {
    ...
    return (
      <div className="wrapper5 col m4 offset-l1">
        <div
          className="form-wrapper4 row "
          style={{ width: "1000px", height: "650px", marginLeft: "165px" }}
        >
          {/* <h3 className="center-align" id="Registertext">{this.props.match.params.name}</h3> */}

          <h3 className="center-align" id="usertext">
            JobSeeker
          </h3>

          <div
            className="userimage"
            style={{ marginLeft: "407px", marginRight: "499px" }}
          >
            <img
         ...
         onClick={this.handleValue}
           ...
           style={{width:'250px'}}>
               ...
               <Multiselect options={this.state.Types}
                ...
                <Popup
                  trigger={
                    <div id="printjobname" onChange={this.handleCheckLength}>
                      <h5 id="valse">select</h5>
                    </div>
                  }
                  position=" center"
                  style={{ width: "250px" }}
            ...
            <div
              class="form-row"
              style={{ marginTop: "-35px", marginLeft: "28px" }}
            >
              <div
                class="col-md-6 mb-3"
                style={{
 ...
 <input type="file" 
            ...
            <div
              class="form-row"
              id="efgh"
              style={{ marginTop: "0px", marginLeft: "25px", display: "none" }}
            >
            ...
            <div
              className="a"
              id="abcd"
              style={{ marginTop: "0px", marginLeft: "30px", display: "none" }}
            >
              {/* <div id="abcd" style={{display:'none'}} className="a" > */}
              <div class="form-row">
                <div
                  class="col-md-4 mb-3 years"
                  style={{ paddingRight: "42px", paddingLeft: "24px" }}
                >
                  <input
                    className=""
    ...
    {this.state.YOP.map(YOPS =>(
          <option key={YOPS} value={YOPS}>
             {YOPS}
                ...
                <div
                  class="col-md-4 mb-3 place"
                  style={{ paddingRight: "-42px", paddingLeft: "94px" }}
                >
                  {/* <div className="place"  > */}
                  <input
                    className=""
              ...
              <div class="form-row">
                <div
                  class="col-md-4 mb-3 designation"
                  style={{
                    paddingRight: "44px",
                    paddingLeft: "23px",
                    marginTop: "-2px",
                ...
                <div
                  className="col-md-4 mb-3 currentLocation"
                  style={{
                    marginLeft: "0px",
                    marginTop: "-2px",
                    paddingRight: "20px",
                ...
                <div
                  class="col-md-4 mb-3 notice_period"
                  style={{
                    marginLeft: "67%",
                    paddingRight: "40px",
                    paddingLeft: "30px",
                ...
                >
                  ...
                  <p id="label" style={{ marginTop: "-17px" }}>
            ...
            <div class="form-row" id="pqrs" style={{ display: "none" }}>
              ...
              <div
                class="col-md-4 mb-3 designation"
                style={{ marginLeft: "32px", paddingRight: "62px" }}
              >
                <input
                  className=""
            ...
            <div class="form-row" id="mnop" style={{ display: "none" }}>
              ...
              <div
                class="col-md-4 mb-3 negotiable"
                style={{
                  display: "flex",
                  marginTop: "-34px",
                  marginLeft: "344px",
              ...
              <div
                class="col-md-4 mb-3 salary"
                style={{ marginLeft: "70%", marginTop: "-79px" }}
              >
                <input
                  style={{ width: "243px" }}
                  placeholder="UpTo"
